<template>
    <nav
            class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top fixed-top navbar-rounded shadow-lg"
            style="z-index: 500;"
    >
        <div class="container">
            <a class="navbar-brand text-dark">#Let's roll</a>
...
<script>
    import {setCurrentTab} from '@/tabs';
    export default {
        name: "NavigationBar",
        methods: {
